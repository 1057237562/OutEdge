...
public class SimpleWing : MonoBehaviour
{
	...
	private void FixedUpdate()
	{
		if (rigid != null && wing != null)
		{
            ...
            if ((liftDirection * liftForce - rigid.velocity.normalized * dragForce).magnitude < Mathf.Infinity)
            {
                rigid.AddForceAtPosition(liftDirection * liftForce - rigid.velocity.normalized * dragForce, forceApplyPos, ForceMode.Force);
            }
		}
	}
