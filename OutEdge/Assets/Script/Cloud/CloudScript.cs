...
public class CloudScript : SceneViewFilter
{
    ...
    public void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        float sunAngle = ui.sunLight.transform.eulerAngles.x;
        ...
        CloudMaterial.SetVector("_SunDir", ui.sunLight.transform ? (-ui.sunLight.transform.forward).normalized : Vector3.up);
