...
namespace LibMMD.Unity3D.BonePose
{
    public class BonePosePreCalculator
    {
        ...
        public BonePosePreCalculator(BonePoseCalculatorWorker worker, Poser poser, MotionPlayer motionPlayer, float stepLength, float startTimePos, int frameCacheSize, bool autoStepLength)
        {
            _poseMode = false;
            _poser = poser;
        ...
        public BonePosePreCalculator(BonePoseCalculatorWorker worker, MmdPose pose, Poser poser, float stepLength,float startTimePos, int frameCacheSize, bool autoStepLength)
        {
            _poseMode = true;
            _poser = poser;
            _stepLength = stepLength;
