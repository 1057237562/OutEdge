...
public class ObjExporter : ScriptableObject
{
        ...
        for (int material = 0; material < m.subMeshCount; material++)
        {
            ...
            try
            {
                ...
                if (mats[material].mainTexture)
                    objMaterial.textureName = mats[material].name;
                else
    ...
    public static Dictionary<string, ObjMaterial> PrepareFileWrite()
    {
        Clear();
    ...
    public static void MaterialsToFile(Dictionary<string, ObjMaterial> materialList, string folder, string filename)
    {
