...
namespace LibMMD.Unity3D
{
    public class MmdGameObject : MonoBehaviour
    {
        ...
        {
            if (_poser == null || _motionPlayer == null)
            {
                return;
            }
            _bonePosePreCalculator =
                new BonePosePreCalculator(BonePoseCalculatorWorker, _poser, _motionPlayer, (float)stepLength, (float)startTimePos,
        ...
        private void StartBonePoseCalculation(MmdPose pose, double stepLength)
        {
            ...
            _bonePosePreCalculator =
                new BonePosePreCalculator(BonePoseCalculatorWorker, pose, _poser, (float)stepLength, 0.0f, PhysicsCacheFrameSize,
